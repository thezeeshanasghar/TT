...
CONFIG = {
    ...
    "mt5_login": 259557289,               # Your MT5 account number
    "mt5_password": "Ae!8bfb666",      # Your MT5 password
    "mt5_server": "Exness-MT5Trial15",   # Your broker's server name (e.g., "ICMarkets-Demo")
    "mt5_path": None,                    # Path to MT5 terminal (None = auto-detect)
    "mt5_timeout": 60000,                # Connection timeout in milliseconds
    
    # Trading
    "symbol": "XAUUSD",  # Changed from XAUUSDm to XAUUSD for Exness
